...
import VoiceAssistantDrawer from './components/VoiceAssistantDrawer';
import { 
      ...
      {currentUser && profile && profile.onboarded && (
        <div className="flex flex-col min-h-screen bg-art-cream">
          ...
          <VoiceAssistantDrawer
            ...
            twinReplyText={twinReplyText}
            assistantTextInput={assistantTextInput}
            setAssistantTextInput={setAssistantTextInput}
            handleAskPresetQuestion={handleAskPresetQuestion}
            startProactiveDailyCheckIn={startProactiveDailyCheckIn}
